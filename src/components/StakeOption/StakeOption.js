    ...
    >
      ...
      <label className={classes.main} htmlFor={props.data.id}>
        <div className={classes.pair}>
          ...
          <div className={classes.icon}>
            <img
              src={props.data.reward.iconSrc}
              alt={`${props.data.reward.symbol}`}
            />
          </div>
          <div className={classes.name}>
            <div className={classes.title}>{props.data.name.title}</div>
            <div className={classes.detail}>{props.data.name.detail}</div>
          </div>
        </div>
        <div className={`${classes.profit} ${classes.data}`}>
          <div className={classes.title}>{props.data.profit.title}</div>
        ...
        <div className={`${classes.staked} ${classes.data}`}>
          <div className={classes.title}>{props.data.staked.title}</div>
          <div className={classes.inCrypto}>
        ...
        <div className={classes.apy}>
          ...
          <div className={classes.box}>
            ...
            <div className={classes["tool-controller"]}>{/* <Dialog/> */}@</div>
          </div>
        </div>
